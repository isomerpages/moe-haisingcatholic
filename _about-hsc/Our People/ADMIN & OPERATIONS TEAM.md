...
<tbody>
			...
			<tr>
					<td style="color: black; font-size: 16px; border: 1px solid black;padding: 10px 20px;">Mr Robert Tan</td>
			...
			<tr>
					<td style="color: black; font-size: 16px; border: 1px solid black;padding: 10px 20px;">Mr Khairil Anuar Bin Mohamad Saleh</td>
					<td style="color: black; font-size: 16px; border: 1px solid black;padding: 10px 20px;">Operation Manager</td>
				<td style="font-size: 16px; border: 1px solid black;padding: 10px 20px;"><a href="mailto:HSHS@moe.edu.sg">HSHS@moe.edu.sg</a></td>
			</tr> 
</tbody>
</table>